...
void I0ServoArray::moveServo3Series(float servo1Angle, float servo2Angle, float servo3Angle) {
...
void I0ServoArray::moveServo3Sync(float servo1Angle, float servo2Angle, float servo3Angle) {
...
int I0ServoArray::getMaxMicroSecondsDiff(int diff1MicroSeconds, int diff2MicroSeconds, int diff3MicroSeconds) {
  int arr[SERVOS_COUNT] = { diff1MicroSeconds, diff2MicroSeconds, diff3MicroSeconds };

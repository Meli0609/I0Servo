...
#ifndef LIBRARIES_ESP32SERVO_SRC_ESP32PWMX_H_
#define LIBRARIES_ESP32SERVO_SRC_ESP32PWMX_H_
...
public:
  ...
  static ESP32PWMX* ChannelUsed[NUM_PWM];  // used to track whether a channel is in service
...
#endif /* LIBRARIES_ESP32SERVO_SRC_ESP32PWMX_H_ */
